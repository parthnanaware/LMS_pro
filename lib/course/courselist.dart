  ...
  Widget _buildContent(BuildContext context) {
    ...
    return CustomScrollView(
      ...
      slivers: [
        ...
        // Courses Count and Category Info
        SliverToBoxAdapter(
          child: Padding(
                ...
                if (selectedCategory != "All")
                  TextButton(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(IconsaxPlusBold.close_circle, size: 16),
                        SizedBox(width: 4),
                        Text("Clear Filter"),
                      ],
                    ),
        ...
        SliverPadding(
          ...
          sliver: SliverGrid(
            ...
            delegate: SliverChildBuilderDelegate(
                ...
                final duration = c["duration"] ?? "4 weeks";
    ...
    return AnimatedContainer(
      ...
      child: _showSearch
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(IconsaxPlusBold.search_normal_1, color: theme.colorScheme.primary),
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    backgroundColor:
                    isSelected ? theme.colorScheme.primary.withOpacity(0.1) : theme.colorScheme.surfaceVariant,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12),
                      side: BorderSide(
                        color: isSelected
